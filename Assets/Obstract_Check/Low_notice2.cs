...
public class Low_notice2 : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider other)
    {
        ...
        if(other.gameObject.CompareTag("Building")){
            Vector3 hitPos = other.ClosestPointOnBounds(_drone.transform.position);
    ...
    //         }
    //         Debug.Log("gameobject: " + hit + "distance: " + hit.ClosestPointOnBounds(drone.transform.position));
    //     }
